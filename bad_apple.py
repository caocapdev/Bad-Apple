...
def main():
    while True:
        user_input = input("Chon kich co khung hinh (mac dinh la 150): ")
        user_input.strip()
        try:
            global frame_size
        ...
        sys.stdout.write(
            '==============================================================\n')
        sys.stdout.write('Hay chon: \n')
        sys.stdout.write('1) Play\n')
        sys.stdout.write('2) Exit\n')
        sys.stdout.write(
            '==============================================================\n')

        user_input = str(input("Tuy chon cua ban: "))
        user_input.strip()

        if user_input == '1':
            sys.stdout.write('File mp3 goc (0), Midi (1)\n')
            user_input = str(input("Bam 0 hoac 1: "))
            user_input.strip()
            if user_input == '0':
                ...
                sys.stdout.write('Tuy chon sai, ban hay chon lai\n')
            continue
        elif user_input == '2':
            exit()
            continue
